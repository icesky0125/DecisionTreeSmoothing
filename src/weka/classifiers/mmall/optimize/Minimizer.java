...
public class Minimizer{
	...
	public Result run(DifferentiableFunction fun, double[] startingPoint) 
		...
		IterationsInfo info = alg.iterate(fun, stopConditions.getMaxIterations(), listener);
		Result result = new Result(alg.getX(), alg.getFunctionValue(), alg.getGradient(), info);
		alg.close();
