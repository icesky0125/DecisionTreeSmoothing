...
public class DBLParametersFlat extends DBLParameters {

	/**
	 * Constructor called by wdAnJE
	 */
	public DBLParametersFlat(int n, int nc, int N, int[] in_ParamsPerAtt, int m_P, int numTuples) {
				...
				for (int u2 = 0; u2 < u1; u2++) {
					...
					for (int u3 = 0; u3 < u2; u3++) {
						...
						for (int u4 = 0; u4 < u3; u4++) {
							...
							index = (int) getAttributeIndex(u1, x_u1, u2, x_u2, u3, x_u3, u4, x_u4, x_C);
							incCountAtFullIndex(index);
						}
					}
				}
					...
					for (int u3 = 0; u3 < u2; u3++) {
						...
						for (int u4 = 0; u4 < u3; u4++) {
							...
							for (int u5 = 0; u5 < u4; u5++) {
								...
								index = (int) getAttributeIndex(u1, x_u1, u2, x_u2, u3, x_u3, u4, x_u4, u5, x_u5, x_C);
								incCountAtFullIndex(index);
							}
						}
					}
