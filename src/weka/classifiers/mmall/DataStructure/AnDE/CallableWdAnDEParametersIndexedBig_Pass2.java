package weka.classifiers.mmall.DataStructure.AnDE;
...
public class CallableWdAnDEParametersIndexedBig_Pass2 implements Callable<Double> {
	...
	public CallableWdAnDEParametersIndexedBig_Pass2(int start, int stop, Instances data, int numTuples, int[] XYCount, wdAnDEParametersIndexedBig dParameters, int th) {
		this.data = data;
		this.start = start;
		this.stop = stop;
