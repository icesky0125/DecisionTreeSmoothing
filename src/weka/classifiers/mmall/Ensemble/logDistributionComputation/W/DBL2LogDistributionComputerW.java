...
public class DBL2LogDistributionComputerW extends LogDistributionComputerDBL {

	public static LogDistributionComputerDBL singleton = null;
	
	protected DBL2LogDistributionComputerW(){}
	public static LogDistributionComputerDBL getComputer() {
		if(singleton==null){
			singleton = new DBL2LogDistributionComputerW();
		}
		return singleton;
	}
