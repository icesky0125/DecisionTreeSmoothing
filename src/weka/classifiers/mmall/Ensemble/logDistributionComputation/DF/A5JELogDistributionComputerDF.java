...
public class A5JELogDistributionComputerDF extends LogDistributionComputerAnJE {

	public static LogDistributionComputerAnJE singleton = null;
	
	protected A5JELogDistributionComputerDF() {}
	public static LogDistributionComputerAnJE getComputer() {
		if(singleton==null){
			singleton = new A5JELogDistributionComputerDF();
		}
		return singleton;
	}
