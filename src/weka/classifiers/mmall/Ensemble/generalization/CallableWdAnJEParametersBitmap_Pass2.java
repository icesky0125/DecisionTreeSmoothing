...
public class CallableWdAnJEParametersBitmap_Pass2 implements Callable<Double> {
	...
	private wdAnJEParametersBitmap dParameters;

	public CallableWdAnJEParametersBitmap_Pass2(int start, int stop, Instances data, int numTuples, int[] XYCount, wdAnJEParametersBitmap dParameters) {
		this.data = data;
		this.start = start;
		this.stop = stop;
