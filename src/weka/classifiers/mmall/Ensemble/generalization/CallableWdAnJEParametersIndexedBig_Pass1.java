...
public class CallableWdAnJEParametersIndexedBig_Pass1 implements Callable<Double> {
	...
	public CallableWdAnJEParametersIndexedBig_Pass1(int start, int stop, Instances data, int numTuples, wdAnJEParametersIndexedBig dParameters) {
		this.data = data;
		this.start = start;
		this.stop = stop;
