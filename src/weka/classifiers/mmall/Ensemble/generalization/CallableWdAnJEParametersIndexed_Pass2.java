...
public class CallableWdAnJEParametersIndexed_Pass2 implements Callable<Double> {
	...
	public CallableWdAnJEParametersIndexed_Pass2(int start, int stop, Instances data, int numTuples, int[] XYCount, wdAnJEParametersIndexed dParameters) {
		this.data = data;
		this.start = start;
		this.stop = stop;
