...
public class CallableWdAnJEParametersBitmap_Pass1 implements Callable<Double> {
	...
	public CallableWdAnJEParametersBitmap_Pass1(int start, int stop, Instances data, int numTuples, wdAnJEParametersBitmap dParameters) {
		this.data = data;
		this.start = start;
		this.stop = stop;
