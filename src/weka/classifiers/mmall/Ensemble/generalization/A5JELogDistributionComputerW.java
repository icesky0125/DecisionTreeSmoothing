					...
					for (int att3 = 2; att3 < att2; att3++) {
						...
						for (int att4 = 1; att4 < att3; att4++) {
							...
							for (int att5 = 0; att5 < att4; att5++) {
								...
								long index1 = params.getAttributeIndex(att1, att1val, att2, att2val, att3, att3val, att4, att4val, att5, att5val, c);
								int index2 = params.getAttributeIndexIndex(att1,att2,att3,att4,att5);
