...
public class SUtils {
	...
	public static double minAbsValueInAnArray(int[] array) {
		int index = 0;
	...
	public static double Laplace(double freq1, double freq2, double numValues) {
		...
		double mEsti = (freq1 + 1) / (freq2 + numValues);
		if(Double.isNaN(mEsti) && freq1==0.0){
			mEsti = 0.0;
		}
		return mEsti;
	...
	public static void setMEsti(double m) {
		m_MEsti = m;
	}
	
	public static double getMEsti() {
		return m_MEsti;
	}
